								...
								<td style="background-image: url('[r: tblImage("mainTheme",49)]'); background-repeat: repeat-y; padding-left: 10px; padding-right: 10px; text-align: center;">
									...
									<table style='border-spacing: 0px;' cellpadding='5'>
										<tr>
											...
											<td>
												<span style='color: #eee5c8; text-decoration: none;' title='Umrechner f&uuml;r Gewichtsma&szlig;e aufrufen'>[r: macroLink("Gewichtsrechner", "gewichtsrechner@Lib:tools")]</span>
											</td>
										</tr>
										<tr>
											<td style='text-align: center;'>
											...
											<td>
												<span style='color: #eee5c8; text-decoration: none;' title='Umrechner f&uuml;r L&auml;ngenma&szlig; aufrufen'>[r: macroLink("L&auml;ngenrechner", "laengenrechner@Lib:tools")]</span>
											</td>
										</tr>
										<tr>
											<td style='text-align: center;'>
											...
											<td>
												<span style='color: #eee5c8; text-decoration: none;' title='Umrechner f&uuml;r W&auml;hrungen aufrufen'>[r: macroLink("W&auml;hrungsrechner", "waehrung@Lib:tools")]</span>
											</td>
										</tr>
									</table>
									<br>
									...
									<table style='border-spacing: 0px;' cellpadding='5'>
										<tr>
											...
											<td>
												<span style='color: #eee5c8; text-decoration: none;' title='Das Steuerungsfenster f&uuml;r den Kalender aufrufen'>[r: macroLink("Kalender-Steuerung", "kalenderMain@Lib:tools", "")]</span>
											</td>
										</tr>
									</table>
									<br>
										...
										<table style='border-spacing: 0px;' cellpadding='0' width='399'>
											<tr>
												...
												<td style='text-align: center;' width='13'>
													<a href="[r: macroLinkText("weblinkAdd@Lib:tools")]"><image src='[r: tableImage("mainTheme", 97)]' border="0" alt="Einen neuen Weblink hinzuf&uuml;gen"></image></a>
												</td>
												<td style='text-align: right;' width='13'>
													<a href="[r: macroLinkText("weblinkDel@Lib:tools", "", "all")]"><image src='[r: tableImage("mainTheme", 98)]' border="0" alt="Alle Weblinks l&ouml;schen"></image></a>
												</td>
											</tr>
										</table>
									</div>
										...
										[Foreach(link, linklist,""), CODE:
											{
												...
												<tr>
													...
													<td style='text-align: center;'>
														<a href="[r: macroLinkText("weblinkDel@Lib:tools", "", num)]"><image src='[r: tableImage("mainTheme", 100)]' border="0" alt="Diesen Weblink l&ouml;schen"></image></a>
													</td>
												</tr>
												[h: num = num + 1]
											}
