[h: setLibProperty("SLframe", 5, "Lib:macros")]
											...
											<table style='border-spacing: 0px; margin-bottom: 3px;' cellpadding='0'>
												<tr>
													...
													<td style='padding: 0px 1px 0px 1px;'>
														[r,if(listFind(hShared, num) != -1): hShareLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout ist f&uuml;r Spieler freigegeben - Klicken zum Sperren'></image></a>", macroLinkText("handoutShare@Lib:macros2", "", id), tableImage("mainTheme", 102)); hShareLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout ist f&uuml;r Spieler gesperrt - Klicken zum Freigeben'></image></a>", macroLinkText("handoutShare@Lib:macros2", "", id), tableImage("mainTheme", 103))]
													</td>
													<td style='padding: 0px 1px 0px 1px;'>
														[r: hEditLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout editieren'></image></a>", macroLinkText("handoutEdit@Lib:macros2", "", id), tableImage("mainTheme", 104))]
													</td>
													<td style='padding: 0px 1px 0px 1px;'>
														[r: hDelLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout sperren &amp; l&ouml;schen'></image></a>", macroLinkText("handoutDel@Lib:macros2", "", id), tableImage("mainTheme", 105))]
													</td>
													<td style='padding: 0px 1px 0px 1px;'>
														[r: hShowLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout anzeigen'></image></a>", macroLinkText("handoutShow@Lib:macros2", "", id), tableImage("mainTheme", 106))]
													</td>
												</tr>
											</table>
