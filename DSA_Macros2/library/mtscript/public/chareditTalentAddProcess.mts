...
[h: ausdruckVergleich = getLibProperty("ImpAusdruckVergleich", "Lib:macros")]
...
[h,foreach(tDaten, tBaum, ""), CODE:
	{
		[if(json.get(tDaten, "Talent") == tName), Code:
			{
				[h,macro("inputFail@Lib:macros"): "talentDouble"]
			}
		]
	}
]
...
[h,macro("noticeSelf@Lib:macros"): "chareditTalentAdd"]
