...
[h: ausdruckVergleich = getLibProperty("ImpAusdruckVergleich", "lib:com.github.naxos.Macros")]
...
[h,foreach(tDaten, tBaum, ""), CODE:
	{
		[if(json.get(tDaten, "Talent") == tName), Code:
			{
				[h,macro("inputFail@lib:com.github.naxos.Macros"): "talentDouble"]
			}
		]
	}
]
...
[h,macro("noticeSelf@lib:com.github.naxos.Macros"): "chareditTalentAdd"]
