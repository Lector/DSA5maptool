...
{
	[h,macro("inputFail@Lib:macros"): "multipleSwarms"]
};{}]
...
[h,if(first == ""),Code:
{
	[h,macro("inputFail@Lib:macros") : "swarmMergeInfoMissing"]
}]
...
[h,foreach(tok, tokens),Code:
{
	...
	(SchwarmGG != gg && SchwarmGG != "")), Code:{
		[h,macro("inputFail@Lib:macros"): "swarmsDifferent"]
	}]
}]
...
[h,if(num < gg),Code:{
	[h,macro("inputFail@Lib:macros"): "swarmTooSmallToMerge"]
}]
...
[h,macro("checkZustand@Lib:macros"): first]
