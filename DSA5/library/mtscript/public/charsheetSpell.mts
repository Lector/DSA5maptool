...
case "spell": {
    ...
    [list = Zauber]
    [listName = "Zauber"]
    [wikiLink = "https://dsa.ulisses-regelwiki.de/zauber.html?zauber=%s"]
    [mac = "probeZauber"]
...
case "ritual": {
    ...
    [list = Rituale]
    [listName = "Rituale"]
    [wikiLink = "https://dsa.ulisses-regelwiki.de/ritual.html?ritual=%s"]
    [mac = "probeRitual"]
...
case "chant": {
    ...
    [list = Liturgien]
    [listName = "Liturgien"]
    [wikiLink = "https://dsa.ulisses-regelwiki.de/liturgie.html?liturgie=%s"]
    [mac = "probeLiturgie"]
...
case "ceremony": {
    ...
    [list = Zeremonien]
    [listName = "Zeremonien"]
    [wikiLink = "https://dsa.ulisses-regelwiki.de/zeremonie.html?zeremonie=%s"]
    [mac = "probeZeremonie"]
