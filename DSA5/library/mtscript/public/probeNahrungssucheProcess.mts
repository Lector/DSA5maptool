...
[h: probeParams = json.set(probeParams, "Name", "Pflanzenkunde", "spec", "Nutzpflanzen", "QSMatter", 6)]
<!-- würfel Probe -->
...
[h,if(json.get(resultPflanzenkunde, "success") > 0),Code:
{
	...
	[h: probeParams = json.set(probeParams, "Name", "Sinnesschärfe", "spec", "Suchen", "modMacroParams", uebergabe, "QSMatter", 6)]
