...
[h,token(idUhr): setTokenImage(data.getStaticData("com.github.lector.dsa5maptool", "/public/images/clock/clock_" + math.mod(number(substring(uhrNeu, 0, 2)), 12) + ".png"), idUhr, mapName)]
