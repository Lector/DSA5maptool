...
[h,if(success == 1): erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeErfolg.png"); erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeFehlschlag.png")]
[h,if(listContains(diceList, "1") == 2): erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeErfolgGluecklich.png")]
[h,if(listContains(diceList, "1") == 3): erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeErfolgSpektakulaer.png")]
[h,if(listContains(diceList, "20") == 2): erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probePatzer.png")]
[h,if(listContains(diceList, "20") == 3): erfolgImage = data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probePatzerSpektakulaer.png")]
...
", data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/balkenDoppelt.png"), tName, data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/balkenEinfach.png"), data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeTalentTitle.png"), tE1AktWert, dice1Color, dice1, tE2AktWert, dice2Color, dice2, tE3AktWert, dice3Color, dice3, tWert, modColor, modOutput, tapColor, tap, erfolgImage)] 
...
", data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeZusatz.png"))]
...
", data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/balkenSchmal.png"))]
...
[h,switch(chat), Code:
	...
	case "3": {
			[h,macro("sendToSelfGM@lib:com.github.lector.dsa5maptool"): ausgabe]
		};
	case "4": {
			[h,macro("sendToSelf@lib:com.github.lector.dsa5maptool"): ausgabe]
		}
]