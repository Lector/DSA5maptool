...
[h: zone = macro.args]
[h,if(getLibProperty("OptWunden", "com.github.lector.dsa5maptool") != 2), Code:
	{
...
[h: sortInitiative()]
[h,if(getLibProperty("OptKampfAU", "com.github.lector.dsa5maptool") == 1): auSchaden = 1d6; auSchaden = 0]
...
[h: checkList = getLibProperty("ImpAusdruckVergleich", "com.github.lector.dsa5maptool")]
...
[h,if(meldungSterbend == 1 && getState("sterbend") == 0), Code:
	{
		...
		", data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeZusatz.png"), deathTime)]
	};{}
]
...
[h,if(meldungBewusstlos == 1 && getState("bewusstlos") == 0), Code:
	{
		...
		", data.getStaticData("com.github.lector.dsa5maptool", "/public/images/chat/probeZusatz.png"), bewusstlosDauer)]
	};{}
]
