							...
							<tr>
								<td style="background-image: url('[r: tblImage("mainTheme",49)]'); background-repeat: repeat-y; padding-left: 10px; padding-right: 10px; height: 28; font-weight: normal; font-size: 11pt;">
									...
									[h,count(hCount, ""), Code:
									{
										...
										[hLink = strformat("<a href='%s'><image src='%s' border='0' alt='Handout anzeigen'></image></a>", macroLinkText("handoutShow@lib:com.github.naxos84.Macros2", "", id), tableImage("mainTheme", 101))]
