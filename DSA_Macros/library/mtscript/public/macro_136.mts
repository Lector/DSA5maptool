...
[h,macro("probeGetWert@Lib:macros"): json.get(uebergabe, "E1")]
[h: e1wert = macro.return]
[h,macro("probeGetAktWert@Lib:macros"): json.get(uebergabe, "E1")]
[h: e1aktwert = macro.return]
[h: uebergabe = json.set(uebergabe, "E1Wert", e1wert)]
[h: uebergabe = json.set(uebergabe, "E1AktWert", e1aktwert)]

[h,macro("probeGetWert@Lib:macros"): json.get(uebergabe, "E2")]
[h: e2wert = macro.return]
[h,macro("probeGetAktWert@Lib:macros"): json.get(uebergabe, "E2")]
[h: e2aktwert = macro.return]
[h: uebergabe = json.set(uebergabe, "E2Wert", e2wert)]
[h: uebergabe = json.set(uebergabe, "E2AktWert", e2aktwert)]

[h,macro("probeGetWert@Lib:macros"): json.get(uebergabe, "E3")]
[h: e3wert = macro.return]
[h,macro("probeGetAktWert@Lib:macros"): json.get(uebergabe, "E3")]
